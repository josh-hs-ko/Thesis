...
comp⁺-collapse⁺ : {I : Set} {X Y Z : I → Set} → (Rs : CompChain⁺ Y Z) (S : X ↝⁺ Y) → comp⁺ Rs S ≃⁺ collapse⁺ Rs •⁺ S
comp⁺-collapse⁺ (R    ◇⁺) S = ≃⁺-refl
comp⁺-collapse⁺ (R ▪⁺ Rs) S = ≃⁺-trans (•⁺-cong-l R (comp⁺-collapse⁺ Rs S)) (≃⁺-sym (•⁺-assoc R (collapse⁺ Rs) S))
...
⊆⁺-chain-r {I} {X} {Y} {Z} Rs Ss Rs⊆⁺Ss {T} =
  begin
    comp⁺ Rs T
      ⊆⁺⟨ proj₁ (comp⁺-collapse⁺ Rs T) ⟩
    collapse⁺ Rs •⁺ T
      ⊆⁺⟨ •⁺-monotonic-r T Rs⊆⁺Ss ⟩
    collapse⁺ Ss •⁺ T
      ⊆⁺⟨ proj₂ (comp⁺-collapse⁺ Ss T) ⟩
    comp⁺ Ss T
  ∎
  where open PreorderReasoning (⊆⁺-Preorder X Z) renaming (_∼⟨_⟩_ to _⊆⁺⟨_⟩_)
...
collapse⁺-appendChain⁺ :
  {I : Set} {X Y Z : I → Set} (Rs : CompChain⁺ Y Z) (Ss : CompChain⁺ X Y) → collapse⁺ (appendChain⁺ Rs Ss) ≃⁺ collapse⁺ Rs •⁺ collapse⁺ Ss
collapse⁺-appendChain⁺ (R    ◇⁺) Ss = ≃⁺-refl
collapse⁺-appendChain⁺ (R ▪⁺ Rs) Ss = ≃⁺-trans (•⁺-cong-l R (collapse⁺-appendChain⁺ Rs Ss)) (≃⁺-sym (•⁺-assoc R (collapse⁺ Rs) (collapse⁺ Ss)))

chain-normalise⁺ : {I : Set} {X Y : I → Set} (Rs : CompTree⁺ X Y) → collapseTree⁺ Rs ≃⁺ collapse⁺ (toChain⁺ Rs)
chain-normalise⁺ [ x ]⁺ = ≃⁺-refl
chain-normalise⁺ (Rs ▪⁺ Ss) = ≃⁺-trans (•⁺-cong (chain-normalise⁺ Rs) (chain-normalise⁺ Ss))
                                      (≃⁺-sym (collapse⁺-appendChain⁺ (toChain⁺ Rs) (toChain⁺ Ss)))
