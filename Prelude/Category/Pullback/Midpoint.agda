...
midpoint-square : Square C Construction.f Construction.g
midpoint-square = span (object SpanUR X×Y×Z) (morphism SpanUR Construction.X×Y×Z-to-X×Z) (morphism SpanUR Construction.X×Y×Z-to-Y×Z)

midpoint-pullback : Pullback C Construction.f Construction.g midpoint-square
midpoint-pullback = < Construction.Universality.W-to-X×Y×Z , Construction.Universality.Uniqueness.uniqueness >
